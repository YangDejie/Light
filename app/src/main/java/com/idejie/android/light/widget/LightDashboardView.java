package com.idejie.android.light.widget;
...
/**
 * Created by shandongdaxue on 2016/11/30.
 */
public class LightDashboardView extends View {
    private int mRadius; // 扇形半径
    private int mStartAngle = 180; // 起始角度
    private int mSweepAngle = 180; // 绘制角度
    private int mMin = 0; // 最小值
    private int mMax = 10000; // 最大值
    private int mSection = 10; // 值域（mMax-mMin）等分份数
    private int mPortion = 100; // 一个mSection等分份数
    private String mHeaderText = "亮度"; // 表头
    ...
    public LightDashboardView(Context context) {
        this(context, null);
    }

    public LightDashboardView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LightDashboardView(Context context, AttributeSet attrs, int defStyleAttr) {
